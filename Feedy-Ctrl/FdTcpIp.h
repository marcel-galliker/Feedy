...
#define MOTOR_STEP				0x01002011
#define MOTOR_START				0x01002012
#define MOTOR_STOP				0x01002013
#define MOTOR_RUN				0x01002014
#define MOTOR_MOVE2POS			0x01002015

#define OPEN_GRIPPER			0x01002020
#define CLOSE_GRIPPER			0x01002021
